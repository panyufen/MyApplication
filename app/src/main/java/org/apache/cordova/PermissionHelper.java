 ...
 * written for org.apache.cordova-android 5.0.0+ can still compile with earlier org.apache.cordova-android versions.
 */
public class PermissionHelper {
     ...
     * built with org.apache.cordova-android 5.0.0+
     *
    ...
    public static void requestPermissions(CordovaPlugin plugin, int requestCode, String[] permissions) {
        try {
            ...
            // If there is no exception, then this is org.apache.cordova-android 5.0.0+
            requestPermission.invoke(plugin.cordova, plugin, requestCode, permissions);
        } catch (NoSuchMethodException noSuchMethodException) {
            // org.apache.cordova-android version is less than 5.0.0, so permission is implicitly granted
     ...
     * be built with org.apache.cordova-android 5.0.0+
     *
    ...
    private static void deliverPermissionResult(CordovaPlugin plugin, int requestCode, String[] permissions) {
        ...
        try {
            ...
            // Should never be caught since the plugin must be written for org.apache.cordova-android 5.0.0+ if it
            ...
            // This method may throw a JSONException. We are just duplicating org.apache.cordova-android's
