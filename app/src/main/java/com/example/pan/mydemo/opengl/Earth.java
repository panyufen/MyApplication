...
public class Earth {
    ...
    int vCount=0;
    public  Earth(SkySurfaceView mv , float r, Context context){
    ...
    public  void initVertexData(float r)
    {
        ...
        ArrayList<Float>alVertix=new ArrayList<Float>();//存放顶点坐标数据ArrayList
    ...
    public  void initShaderGLSL(SkySurfaceView mv)  //初始化着色器
    {
        //加载顶点着色器的内容
        mVertexShader= ShaderUtil.loadFromRawFile(context, R.raw.vertex_earth);
//记载片元着色器内容
        mFragmentShader=ShaderUtil.loadFromRawFile(context,R.raw.frag_earth);
        //基于顶点着色器与片元着色器创建程序
    ...
    public  void  drawSelf(int texId,int texIdNight){
        ...
        GLES30.glBindTexture(GLES20.GL_TEXTURE_2D,texId);//白天纹理
        GLES30.glActiveTexture(GLES30.GL_TEXTURE1);
        GLES30.glBindTexture(GLES20.GL_TEXTURE_2D,texIdNight);//夜晚纹理
