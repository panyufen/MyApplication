...
public class Moon {
    ...
    public  void  initShaderGLSL(MySurfaceView mv){

        mVertexShader=ShaderUtil.loadFromRawFile(context,R.raw.vertex_moon);
        ShaderUtil.checkGlError("==ss==");
        mFragmentShader=ShaderUtil.loadFromRawFile(context,R.raw.frag_moon);
    ...
    public void drawSlef(int texId){
...
public class Moon
{
    ...
    public Moon(SkySurfaceView mv,float r,Context context)
    {
        this.context=context;
        //调用初始化顶点数据的方法
        initVertexData(r);
    ...
    //初始化着色器
    public void initShader(SkySurfaceView mv)
    {
        mVertexShader= ShaderUtil.loadFromRawFile(context, R.raw.vertex_moon);
        ShaderUtil.checkGlError("==ss==");
        mFragmentShader=ShaderUtil.loadFromRawFile(context,R.raw.frag_moon);
