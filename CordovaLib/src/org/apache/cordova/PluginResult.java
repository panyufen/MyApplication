...
public class PluginResult {
    ...
    public String toSuccessCallbackString(String callbackId) {
        return "org.apache.org.apache.cordova.callbackSuccess('"+callbackId+"',"+this.getJSONString()+");";
    }

    @Deprecated // Use sendPluginResult instead of sendJavascript.
    public String toErrorCallbackString(String callbackId) {
        return "org.apache.org.apache.cordova.callbackError('"+callbackId+"', " + this.getJSONString()+ ");";
    }
