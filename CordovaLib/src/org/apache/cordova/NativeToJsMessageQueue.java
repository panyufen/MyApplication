...
public class NativeToJsMessageQueue {
    ...
    public String popAndEncodeAsJs() {
        synchronized (this) {
            ...
            if (!willSendAllMessages) {
                sb.append("window.setTimeout(function(){org.apache.org.apache.cordova.require('org.apache.org.apache.cordova/plugin/android/polling').pollOnce();},0);");
            }
    ...
    public static class LoadUrlBridgeMode extends BridgeMode {
        ...
        public void onNativeToJsMessageAvailable(final NativeToJsMessageQueue queue) {
            LOG.i("BridgeMode","LoadUrlBridgeMode");
    ...
    public static class OnlineEventsBridgeMode extends BridgeMode {
        ...
        @Override
        public void onNativeToJsMessageAvailable(final NativeToJsMessageQueue queue) {
            LOG.i("BridgeMode","OnlineEventsBridgeMode");
            delegate.runOnUiThread(new Runnable() {
                public void run() {
                    if (!queue.isEmpty()) {
    ...
    private static class JsMessage {
        ...
        void encodeAsJsMessage(StringBuilder sb) {
            if (pluginResult == null) {
                ...
                sb.append("org.apache.org.apache.cordova.callbackFromNative('")
                  .append(jsPayloadOrCallbackId)
                  .append("',")
                  .append(success)
                  .append(",")
                ...
                switch (pluginResult.getMessageType()) {
                    case PluginResult.MESSAGE_TYPE_BINARYSTRING:
                        ...
                        break;
                    case PluginResult.MESSAGE_TYPE_ARRAYBUFFER:
                        sb.append("org.apache.org.apache.cordova.require('org.apache.org.apache.cordova/base64').toArrayBuffer('")
                          .append(pluginResult.getMessage())
                          .append("')");
                        break;
                    default:
